 ...
 * Si value está entre 0 y 7 (ambos incluidos),
...
/* value representa el dígito que se debe mostrar en el display.
 * Si value está entre 0 y 15 (ambos incluidos) debe escribirse en
